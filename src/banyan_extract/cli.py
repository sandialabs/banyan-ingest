...
def parse_arguments():
    ...
    parser.add_argument("--backend", default="nemoparse", type=str,  help="Which backend to use (nemoparse (default)- Nemotron Parse, marker - marker)")
